          ...
          <div className="border border-(--color-ocean)/60 bg-(--color-light) p-6 shadow-2xl sm:p-10">
            ...
            {state === "auth" && (
              <div role="alert">
                ...
                <Link
                  to="/register"
                  className="mt-6 inline-flex items-center justify-center border border-(--color-ocean) px-5 py-3 text-sm uppercase tracking-[0.1em] text-(--color-ink)"
                >
                  Go to application
                </Link>
              </div>
            ...
            {state === "error" && (
              <div role="alert">
                ...
                <p className="mt-3 text-(--color-ocean)">Please try again in a moment.</p>
              </div>
            )}
            {state === "empty" && (
              <div>
            ...
            {state === "ready" && profile && status && (
              <div>
                ...
                <button
                  type="button"
                  onClick={signOut}
                  className="mt-8 text-sm uppercase tracking-[0.12em] text-(--color-ink) underline decoration-(--color-ocean) underline-offset-8"
                >
                  Sign out
                </button>
              </div>
